    ...
    <div className="w-full">
      <div className="w-screen h-[40vh] lg:h-[55vh] relative">
        ...
        <div className="absolute top-[70%] max-w-[1240px] w-full left-[50%] right-[50%] translate-x-[-50%] translate-y-[-50%] text-white z-10 p-2">
          <h2 className="py-2">Champion Headphones</h2>
          <h3 className="py-2">
            React / CSS / Javascript / NEXT / Sanity / Stripe
          </h3>
        </div>
      </div>
      ...
      <div className="max-w-[1240px] mx-auto p-2 grid md:grid-cols-5 gap-8 pt-8">
        <div className="col-span-4">
          ...
          <h2>Overview</h2>
          <p>
            This app was built using Next JS. Users are able to purchase various
            headphones where i used sanity as a content management system and
